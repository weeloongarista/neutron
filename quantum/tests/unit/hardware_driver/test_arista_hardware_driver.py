...
class AristaProvisionedVlansStorageTestCase(base.TestCase):
    def setUp(self):
...
class AristaRPCWrapperInvalidConfigTestCase(base.TestCase):
    def setUp(self):
...
class PositiveRPCWrapperValidConfigTestCase(base.TestCase):
    def setUp(self):
        setup_valid_config()
...
class NegativeRPCWrapperTestCase(base.TestCase):
    def setUp(self):
        setup_valid_config()
...
class FakeNetStorageAristaOVSDriverTestCase(base.TestCase):
    def setUp(self):
...
class KeepAliveServicTestCase(base.TestCase):
    def setUp(self):
...
class RealNetStorageAristaDriverTestCase(base.TestCase):
    def setUp(self):
